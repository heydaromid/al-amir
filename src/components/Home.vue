<template>
    ...
    <div v-if="cardsLoading" class="flex-1 my-20">
      <div class="w-10 h-10 border-4 border-yellow-600 border-t-transparent border-solid rounded-full animate-spin mx-auto"></div>
    </div>
...
const docId = "7a86IfkFNw";
const brandTableId = "grid-5s_DTzk4lU";
const cardsTableId = "grid-OxkfyQYjSp";
const token = "bfeaec88-d680-4fe6-b36f-cfaa1bdec51b";
